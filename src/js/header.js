...
function doSomething(scroll_pos) {
  if (window.location.pathname === '/index.html' || window.location.pathname === '/' || window.location.pathname === '/project-alianza/index.html' || window.location.pathname === '/project-alianza/' || window.location.pathname === '/project-alianza/solar-benefits.html' || window.location.pathname === '/solar-benefits.html') {
    if (scroll_pos > 30) {
